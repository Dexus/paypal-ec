...
/**
 * Make a `createBillingAgreement` API call to PayPal.
 * @public
 * @this {PayPalEC}
 * @param {Object} params Contain the token.
 * @param {Function} callback Function to get called when done.
 */
 ...
 * @public
 * @this {PayPalEC}
 * @param {Object} params Contain the billing agreement ID and all the payment information.
 * @param {Function} callback Function to get called when done.
 */
PayPalEC.prototype.manage_rpp_status = PayPalEC.prototype[ 'doReferenceTransaction' ];
